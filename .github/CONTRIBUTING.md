Contributing to yii2-widget-sidenav
===================================
Looking to contribute something to yii2-widget-sidenav? **Here's how you can help.**
...
[widget documentation and demos](http://demos.krajee.com/widget-details/sidenav) and/or refer to the
[webtips Q & A forum](http://webtips.krajee.com/questions) which are the better places to get help.

Reporting bugs with yii2-widget-sidenav
---------------------------------------
We really appreciate clear bug reports that _consistently_ show an issue
_within yii2-widget-sidenav_.
...
- What version of jQuery are you using? And what version of yii2-widget-sidenav?
- Are you using yii2-widget-sidenav with other plugins?

All of these questions will help others fix and identify any potential bugs.

Requesting features in yii2-widget-sidenav
------------------------------------------
Before starting work on a major feature for yii2-widget-sidenav, **read the
[documentation](http://demos.krajee.com/widget-details/sidenav)  first** or you may risk spending a considerable amount of
...
yii2-widget-sidenav regularly receives new issues which need to be tested and organized.
...
If you can test issues that are reported to yii2-widget-sidenav that contain test cases and
...
It should also be made clear that **all code contributed to yii2-widget-sidenav** must be
licensable under the [BSD-3 license][licensing].  Code that cannot be released
under this license **cannot be accepted** into the project.

[isolated-case]: https://jsfiddle.net/
[issue-search]: https://github.com/kartik-v/yii2-widget-sidenav/search?q=&type=Issues
[issue-tracker]: https://github.com/kartik-v/yii2-widget-sidenav/issues
[licensing]: https://github.com/kartik-v/yii2-widget-sidenav/blob/master/LICENSE.md
[reporting-bugs]: #reporting-bugs-with-yii2-widget-sidenav
[requesting-features]: #requesting-features-in-yii2-widget-sidenav